...
public class SolutionTest {
    ...
    public void basicTest4() {
        ...
        String[] got = MexicanWave.wave("two words");
        assertArrayEquals("it should return '" + Arrays.toString(result) + "', but returns " + Arrays.toString(got),
                result, got);
    }
    ...
    public void basicTest5() {
        ...
        String[] got = MexicanWave.wave(" gap ");
        assertArrayEquals("it should return '" + Arrays.toString(result) + "', but returns " + Arrays.toString(got),
                result, got);
    }
